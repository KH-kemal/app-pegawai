...
<div class="bg-white p-6 rounded-2xl shadow-lg max-w-lg mx-auto">
    <h1 class="text-2xl font-bold text-gray-800 mb-4">Edit Jabatan</h1>
    ...
    <form action="{{ route('positions.update', $position->id) }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="number" name="gaji_pokok" value="{{ old('gaji_pokok', $position->gaji_pokok) }}" step="0.01" min="0"
                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
        </div>
